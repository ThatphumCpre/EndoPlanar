...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.sharp_metric_stop_iter = 2000
        self.sharp = False
        ...
        self.regularize_geometry_only_mask = True
        self.clean_noise = False
        self.color_weight = 1
        self.depth_weight = 1

        self.tv_depth_loss_weight = 0.010
        self.tv_depth_loss_from_iter = 7000

        self.tv_color_loss_weight = 0.010
        self.tv_color_loss_from_iter = 7000

        self.align_loss_from_iter = 7000
        self.align_loss_weight = 0.01
        self.num_frame = 260 
        self.frame_segmented = 65
        ...
        self.adpt_sampling = False
        self.adpt_weight = False
        self.fft_weight_l = 0.5
        self.fft_weight_h = 0.5
        self.fft_from_iter = 500
        self.fft_D0 = 0.4
        self.fft_D = 1.0
        self.T0 = 1500
        self.T = 3000
